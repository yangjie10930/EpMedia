[![](https://img.shields.io/badge/minSdkVersion-16-green.svg)](https://developer.android.google.cn)    [![](https://img.shields.io/badge/release-v0.7-blue.svg)](https://jitpack.io/#yangjie10930/EpMedia)
...
* 添加gradle依赖:
```Java
compile 'com.github.yangjie10930:EpMedia:v0.7'
```
## 单个视频处理:
* 创建待处理视频:
```Java
