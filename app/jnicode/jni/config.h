...
#define FFMPEG_CONFIGURATION "--target-os=android --cross-prefix='/home/jojo/桌面/Android/BianYi/ffmpeg-android-master/toolchain-android/bin/arm-linux-androideabi-' --arch=arm --cpu=cortex-a9 --disable-armv5te --disable-armv6 --disable-armv6t2 --enable-runtime-cpudetect --sysroot='/home/jojo/桌面/Android/BianYi/ffmpeg-android-master/toolchain-android/sysroot' --enable-neon --enable-asm --enable-hwaccel=h264_vaapi --enable-hwaccel=h264_vaapi --enable-hwaccel=h264_dxva2 --enable-hwaccel=mpeg4_vaapi --enable-hwaccels --enable-shared --enable-jni --enable-mediacodec --disable-static --disable-doc --enable-libx264 --enable-libfreetype --enable-libfribidi --enable-libmp3lame --enable-gpl --enable-nonfree --enable-version3 --enable-small --disable-vda --disable-iconv --disable-encoders --enable-encoder=libx264 --enable-encoder=mpeg4 --enable-encoder=aac --enable-encoder=gif --enable-encoder=libmp3lame --disable-muxers --enable-muxer=mp4 --enable-muxer=gif --enable-muxer=mp3 --enable-muxer=mov --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder='mjpeg,png' --enable-decoder=gif --enable-decoder=mp3 --disable-demuxers --enable-demuxer=h264 --enable-demuxer=avi --enable-demuxer=mpc --enable-demuxer=mov --enable-demuxer=image2 --enable-demuxer=concat --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=gif --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --disable-protocols --enable-protocol=file --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --disable-indevs --enable-zlib --enable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-avdevice --disable-doc --disable-symver --pkg-config='/home/jojo/桌面/Android/BianYi/ffmpeg-android-master/ffmpeg-pkg-config' --prefix='/home/jojo/桌面/Android/BianYi/ffmpeg-android-master/build/armeabi-v7a-neon' --extra-cflags='-I/home/jojo/桌面/Android/BianYi/ffmpeg-android-master/toolchain-android/include -fPIC -DANDROID -D__thumb__ -mthumb -Wfatal-errors -Wno-deprecated -mfloat-abi=softfp -mtune=cortex-a9 -mfpu=neon -marm -march=armv7-a -D__ARM_ARCH_7__ -D__ARM_ARCH_7A__' --extra-ldflags='-L/home/jojo/桌面/Android/BianYi/ffmpeg-android-master/toolchain-android/lib' --extra-libs='-lpng -lexpat -lm' --extra-cxxflags="
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "C:/Users/Administrator/Desktop/ffmpeg3.3.4/armeabi-v7a-neon/armeabi-v7a-neon/share/ffmpeg"
#define AVCONV_DATADIR "C:/Users/Administrator/Desktop/ffmpeg3.3.4/armeabi-v7a-neon/armeabi-v7a-neon/share/ffmpeg"
